...
@Component({
  selector: 'app-daily-gift-report-detail',
  templateUrl: './daily-gift-report-detail.component.html',
  styleUrls: ['./daily-gift-report-detail.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class DailyGiftReportDetailComponent implements OnInit {
  ...
  private Url_listing: string = "/auth/report/daily-gift-report";
  ...
  ngOnInit() {
    ...
    this.arrobjDailyUsedGift = JSON.parse(params.get('data'));
  ...
  onReportComplete(): void {
    ...
    this.arrobjDailyUsedGift.unshift(
      {
    ...
    console.log(this.arrobjDailyUsedGift);
