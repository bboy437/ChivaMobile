...
export class RegistrantReportComponent implements OnInit {
  ...
  private Url_Detail: string = "/auth/report/registrant-report-detail";
  ...
  btnPrintClick() {
    ...
    this.brokerAPIService
      .get(this.UrlAPI_GetChivaMemberRegistered + this.arrobjMember.chivaCode + "," + this.frDate + "," + this.toDate).subscribe(
        data => {
          ...
          } if (data == (0) || this.arrobjMember.chivaCode == "")  {
            strValidate = "No data";
