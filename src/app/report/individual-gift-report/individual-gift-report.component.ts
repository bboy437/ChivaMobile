...
@Component({
  ...
  styleUrls: ['./individual-gift-report.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class IndividualGiftReportComponent implements OnInit {
  ...
  private Url_Detail: string = "/auth/report/individual-gift-report-detail";
  private UrlAPI_GetMemberGetGift: string = "Report/GetPersonalUsedGift/";
  ...
  print() {
    this.brokerAPIService
      .get(this.UrlAPI_GetMemberGetGift + this.arrobjMember.chivaCode + "," + this.frDate + "," + this.toDate).subscribe(
        data => {
          this.arrobjPersonalUsedGift = data;
