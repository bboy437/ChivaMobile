...
@Component({
  selector: 'app-daily-promotion-report',
  templateUrl: './daily-promotion-report.component.html',
  styleUrls: ['./daily-promotion-report.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class DailyPromotionReportComponent implements OnInit {
  ...
  private Url_Detail: string = "/auth/report/daily-promotion-report-detail";
  ...
  print() {
    ...
    if (this.objRowHotpitalname == undefined) {
      this.brokerAPIService.get(this.UrlAPI_GetDailyUsedPromotion + this.objRowHotpitalto + "," + this.objRowHotpitalfrom + "," + this.frDate + "," + this.toDate).subscribe(
        data => {
          this.arrobjDailyUsedPromotion = data;
      ...
      this.brokerAPIService.get(this.UrlAPI_GetDailyUsedPromotion + this.objRowHotpitalname + "," + this.objRowHotpitalname + "," + this.frDate + "," + this.toDate).subscribe(
        data => {
          this.arrobjDailyUsedPromotion = data;
          let strValidate: string = "";
          if (this.frDate > this.toDate) {
